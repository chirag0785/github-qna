...
ALTER TABLE "resources" ADD COLUMN "repo_name" varchar(191) NOT NULL;--> statement-breakpoint
ALTER TABLE "resources" ADD COLUMN "file_path" varchar(191) NOT NULL;--> statement-breakpoint
DO $$ BEGIN
...
ALTER TABLE "resources" DROP COLUMN IF EXISTS "content";